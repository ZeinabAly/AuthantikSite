    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <div class="text-tiny">Modifier l'utilisateur</div>
                </li>
            </ul>
        </div>
        <!-- new-category -->
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.user.update', $user)}}" method="POST"
                ...
                <fieldset class="role">
                    ...
                    <input type="checkbox" name="roles[]" id="{{$role->name}}" value="{{$role->id}}" {{ $user->roles->contains($role->id) ? 'checked' : ''}}>
                    @endforeach
